...
const partners = [
  {
    id: 'CN',
    name: 'Camilo Nossa',
    email: 'camilonossa@fusiontech.com',
    role: 'Vendedor',
    status: 'Vacaciones'
  },
  {
  ...
  },
  {
    id: 'CR',
    name: 'Carlos Rojas',
    email: 'carlosroj@fusiontech.com',
    role: 'Marketing',
    status: 'Inactivo'
  },
  {
  ...
  return (
    <div className="container mx-auto p-6">
      ...
      <div className="flex space-x-4 mb-4">
        <Input className="flex-grow" placeholder="Buscar por nombre o rol..." />
            ...
            <TableRow key={partner.id}>
              <TableCell className="font-medium">
                <div className="flex items-center space-x-3">
                  <Avatar className="w-8 h-8">{partner.id}</Avatar>
                  <div>
                    <p>{partner.name}</p>
